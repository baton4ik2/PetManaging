      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
            ...
            >
              {filteredOwners.map((owner) => (
                <div
                  ...
                  className="px-4 py-2 hover:bg-indigo-50 dark:hover:bg-gray-700 cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-b-0 dark:text-white"
                >
          ...
          {showOwnerDropdown && ownerSearch && filteredOwners.length === 0 && (
            ...
            >
              <div className="px-4 py-2 text-gray-500 dark:text-gray-400">No owners found</div>
            </div>
          )}
        </div>
        <div>
